...
namespace Kroeg.ActivityPub.ServerToServer
{
  public class LikeFollowAnnounceHandler : BaseHandler
  {
    ...
    public LikeFollowAnnounceHandler(IEntityStore entityStore, APEntity mainObject, APEntity actor, APEntity targetBox, ClaimsPrincipal user, CollectionTools collection, RelevantEntitiesService relevantEntities, IServiceProvider serviceProvider, DbConnection connection) : base(entityStore, mainObject, actor, targetBox, user)
    {
