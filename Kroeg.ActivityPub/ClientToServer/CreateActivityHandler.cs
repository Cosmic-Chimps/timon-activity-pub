...
namespace Kroeg.Server.Middleware.Handlers.ClientToServer
{
    public class CreateActivityHandler : BaseHandler
    {
        ...
        public CreateActivityHandler(IEntityStore entityStore, APEntity mainObject, APEntity actor, APEntity targetBox, ClaimsPrincipal user, CollectionTools collection, ServerConfig entityData) : base(entityStore, mainObject, actor, targetBox, user)
        {
