...
namespace Kroeg.Server.Middleware.Handlers.ClientToServer
{
    public class AcceptRejectFollowHandler : BaseHandler
    {
        ...
        public AcceptRejectFollowHandler(IEntityStore entityStore, APEntity mainObject, APEntity actor, APEntity targetBox, ClaimsPrincipal user, ServerConfig data, CollectionTools collection) : base(entityStore, mainObject, actor, targetBox, user)
        {
            _data = data;
