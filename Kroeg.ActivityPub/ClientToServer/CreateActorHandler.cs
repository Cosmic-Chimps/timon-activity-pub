...
namespace Kroeg.Server.Middleware.Handlers.ClientToServer
{
    public class CreateActorHandler : BaseHandler
    {
        ...
        public CreateActorHandler(IEntityStore entityStore, APEntity mainObject, APEntity actor, APEntity targetBox, ClaimsPrincipal user, CollectionTools collection, ServerConfig entityData, DbConnection connection) : base(entityStore, mainObject, actor, targetBox, user)
        {
        ...
        public override async Task<bool> Handle()
        {
            ...
            if (!EntityData.IsActor(objectEntity.Data)) return true;
