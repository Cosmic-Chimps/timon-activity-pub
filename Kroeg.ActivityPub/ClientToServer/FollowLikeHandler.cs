...
namespace Kroeg.ActivityPub.ClientToServer
{
    public class FollowLikeHandler : BaseHandler
    {
        ...
        public FollowLikeHandler(IEntityStore entityStore, APEntity mainObject, APEntity actor, APEntity targetBox, ClaimsPrincipal user, CollectionTools collection, ServerConfig data) : base(entityStore, mainObject, actor, targetBox, user)
        {
